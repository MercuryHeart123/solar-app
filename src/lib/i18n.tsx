...
const translations = {
    en: {
        ...
        "result.landing.title": "Your Solar Readiness Results",
        "result.landing.ROI": "Estimated ROI: ~{value} years",
        "reusult.landing.savings":
            "Estimated solar savings of {value} THB per month",
        "result.efficiency.title": "Solar Efficiency",
        "result.efficiency.good": "Good",
        "result.efficiency.neutral": "Neutral",
        "result.efficiency.poor": "Poor",
        "result.efficiency.chart.scoreLabel": "Efficiency score",
        "result.efficiency.chart.datasetLabel": "Efficiency score",
        "result.efficiency.chart.provinceLabel": "{province}",
        "result.efficiency.chart.selectedFallback": "Selected province",
        "result.efficiency.chart.nationalLabel": "National average",
        "result.efficiency.chart.tooltip": "{score}/100 efficiency",
        "result.efficiency.chart.summary":
            "{province} scores {score}/100 ({delta} vs national average {national}/100) with about {sunHours} peak-sun hours per day.",
        "result.efficiency.chart.summaryNoProvince":
            "Pick a province to view a tailored solar efficiency profile.",
        "result.efficiency.card1.title": "Solar Potential",
        "result.efficiency.card1.tooltip": "Solar Potential Info",
        "result.efficiency.card1.unit": "kWh/m²/day",
        ...
        "provinceNames.bkk": "Bangkok",
        "provinceNames.spk": "Samut Prakan",
        "provinceNames.nbi": "Nonthaburi",
        "provinceNames.pte": "Pathum Thani",
        "provinceNames.aya": "Phra Nakhon Si Ayutthaya",
        "provinceNames.atg": "Ang Thong",
        "provinceNames.lri": "Lop Buri",
        "provinceNames.sbr": "Sing Buri",
        "provinceNames.cnt": "Chai Nat",
        "provinceNames.sri": "Saraburi",
        "provinceNames.cbi": "Chon Buri",
        "provinceNames.ryg": "Rayong",
        "provinceNames.cti": "Chanthaburi",
        "provinceNames.trt": "Trat",
        "provinceNames.cco": "Chachoengsao",
        "provinceNames.pri": "Prachin Buri",
        "provinceNames.nyk": "Nakhon Nayok",
        "provinceNames.skw": "Sa Kaeo",
        "provinceNames.nma": "Nakhon Ratchasima",
        "provinceNames.brm": "Buriram",
        "provinceNames.srn": "Surin",
        "provinceNames.ssk": "Si Sa Ket",
        "provinceNames.ubn": "Ubon Ratchathani",
        "provinceNames.yst": "Yasothon",
        "provinceNames.cpm": "Chaiyaphum",
        "provinceNames.acr": "Amnat Charoen",
        "provinceNames.bkn": "Bueng Kan",
        "provinceNames.nbp": "Nong Bua Lam Phu",
        "provinceNames.kkn": "Khon Kaen",
        "provinceNames.udn": "Udon Thani",
        "provinceNames.lei": "Loei",
        "provinceNames.nki": "Nong Khai",
        "provinceNames.mkm": "Maha Sarakham",
        "provinceNames.ret": "Roi Et",
        "provinceNames.ksn": "Kalasin",
        "provinceNames.snk": "Sakon Nakhon",
        "provinceNames.npm": "Nakhon Phanom",
        "provinceNames.mdh": "Mukdahan",
        "provinceNames.cmi": "Chiang Mai",
        "provinceNames.lpn": "Lamphun",
        "provinceNames.lpg": "Lampang",
        "provinceNames.utd": "Uttaradit",
        "provinceNames.pre": "Phrae",
        "provinceNames.nan": "Nan",
        "provinceNames.pyo": "Phayao",
        "provinceNames.cri": "Chiang Rai",
        "provinceNames.msn": "Mae Hong Son",
        "provinceNames.nsn": "Nakhon Sawan",
        "provinceNames.uti": "Uthai Thani",
        "provinceNames.kpt": "Kamphaeng Phet",
        "provinceNames.tak": "Tak",
        "provinceNames.sti": "Sukhothai",
        "provinceNames.plk": "Phitsanulok",
        "provinceNames.pct": "Phichit",
        "provinceNames.pnb": "Phetchabun",
        "provinceNames.rbr": "Ratchaburi",
        "provinceNames.kri": "Kanchanaburi",
        "provinceNames.spb": "Suphan Buri",
        "provinceNames.npt": "Nakhon Pathom",
        "provinceNames.skn": "Samut Sakhon",
        "provinceNames.skm": "Samut Songkhram",
        "provinceNames.pbi": "Phetchaburi",
        "provinceNames.pkn": "Prachuap Khiri Khan",
        "provinceNames.nrt": "Nakhon Si Thammarat",
        "provinceNames.kbi": "Krabi",
        "provinceNames.pna": "Phangnga",
        "provinceNames.pkt": "Phuket",
        "provinceNames.sni": "Surat Thani",
        "provinceNames.rng": "Ranong",
        "provinceNames.cpn": "Chumphon",
        "provinceNames.ska": "Songkhla",
        "provinceNames.stn": "Satun",
        "provinceNames.trg": "Trang",
        "provinceNames.plg": "Phatthalung",
        "provinceNames.ptn": "Pattani",
        "provinceNames.yla": "Yala",
        "provinceNames.nwt": "Narathiwat",
        "provinceNames.lksg": "Lake Songkha",
    ...
    th: {
        ...
        "result.landing.title": "ผลลัพธ์ความพร้อมติดตั้งโซลาร์เซลล์ของคุณ",
        "result.landing.ROI": "ประมาณการคืนทุน: ~{value} ปี",
        "reusult.landing.savings":
            "ประหยัดค่าไฟฟ้าได้ประมาณ {value} บาทต่อเดือน",
        "result.efficiency.title": "ประสิทธิภาพพลังงานแสงอาทิตย์",
        "result.efficiency.good": "ดี",
        "result.efficiency.neutral": "ปานกลาง",
        "result.efficiency.poor": "ต่ำ",
        "result.efficiency.chart.scoreLabel": "คะแนนประสิทธิภาพ",
        "result.efficiency.chart.datasetLabel": "คะแนนประสิทธิภาพ",
        "result.efficiency.chart.provinceLabel": "{province}",
        "result.efficiency.chart.selectedFallback": "จังหวัดที่เลือก",
        "result.efficiency.chart.nationalLabel": "ค่าเฉลี่ยทั้งประเทศ",
        "result.efficiency.chart.tooltip": "ประสิทธิภาพ {score}/100",
        "result.efficiency.chart.summary":
            "{province} ทำคะแนนได้ {score}/100 ({delta} เมื่อเทียบกับค่าเฉลี่ยประเทศ {national}/100) และมีชั่วโมงแดดสูงสุดเฉลี่ยราว {sunHours} ชั่วโมงต่อวัน",
        "result.efficiency.chart.summaryNoProvince":
            "เลือกจังหวัดเพื่อดูข้อมูลประสิทธิภาพพลังงานแสงอาทิตย์เฉพาะพื้นที่",
        "result.efficiency.card1.title": "ศักยภาพพลังงานแสงอาทิตย์",
        "result.efficiency.card1.tooltip": "ข้อมูลศักยภาพพลังงานแสงอาทิตย์",
        "result.efficiency.card1.unit": "กิโลวัตต์ชั่วโมง/ตารางเมตร/วัน",
        ...
        "provinceNames.bkk": "กรุงเทพมหานคร",
        "provinceNames.spk": "สมุทรปราการ",
        "provinceNames.nbi": "นนทบุรี",
        "provinceNames.pte": "ปทุมธานี",
        "provinceNames.aya": "พระนครศรีอยุธยา",
        "provinceNames.atg": "อ่างทอง",
        "provinceNames.lri": "ลพบุรี",
        "provinceNames.sbr": "สิงห์บุรี",
        "provinceNames.cnt": "ชัยนาท",
        "provinceNames.sri": "สระบุรี",
        "provinceNames.cbi": "ชลบุรี",
        "provinceNames.ryg": "ระยอง",
        "provinceNames.cti": "จันทบุรี",
        "provinceNames.trt": "ตราด",
        "provinceNames.cco": "ฉะเชิงเทรา",
        "provinceNames.pri": "ปราจีนบุรี",
        "provinceNames.nyk": "นครนายก",
        "provinceNames.skw": "สระแก้ว",
        "provinceNames.nma": "นครราชสีมา",
        "provinceNames.brm": "บุรีรัมย์",
        "provinceNames.srn": "สุรินทร์",
        "provinceNames.ssk": "ศรีสะเกษ",
        "provinceNames.ubn": "อุบลราชธานี",
        "provinceNames.yst": "ยโสธร",
        "provinceNames.cpm": "ชัยภูมิ",
        "provinceNames.acr": "อำนาจเจริญ",
        "provinceNames.bkn": "บึงกาฬ",
        "provinceNames.nbp": "หนองบัวลำภู",
        "provinceNames.kkn": "ขอนแก่น",
        "provinceNames.udn": "อุดรธานี",
        "provinceNames.lei": "เลย",
        "provinceNames.nki": "หนองคาย",
        "provinceNames.mkm": "มหาสารคาม",
        "provinceNames.ret": "ร้อยเอ็ด",
        "provinceNames.ksn": "กาฬสินธุ์",
        "provinceNames.snk": "สกลนคร",
        "provinceNames.npm": "นครพนม",
        "provinceNames.mdh": "มุกดาหาร",
        "provinceNames.cmi": "เชียงใหม่",
        "provinceNames.lpn": "ลำพูน",
        "provinceNames.lpg": "ลำปาง",
        "provinceNames.utd": "อุตรดิตถ์",
        "provinceNames.pre": "แพร่",
        "provinceNames.nan": "น่าน",
        "provinceNames.pyo": "พะเยา",
        "provinceNames.cri": "เชียงราย",
        "provinceNames.msn": "แม่ฮ่องสอน",
        "provinceNames.nsn": "นครสวรรค์",
        "provinceNames.uti": "อุทัยธานี",
        "provinceNames.kpt": "กำแพงเพชร",
        "provinceNames.tak": "ตาก",
        "provinceNames.sti": "สุโขทัย",
        "provinceNames.plk": "พิษณุโลก",
        "provinceNames.pct": "พิจิตร",
        "provinceNames.pnb": "เพชรบูรณ์",
        "provinceNames.rbr": "ราชบุรี",
        "provinceNames.kri": "กาญจนบุรี",
        "provinceNames.spb": "สุพรรณบุรี",
        "provinceNames.npt": "นครปฐม",
        "provinceNames.skn": "สมุทรสาคร",
        "provinceNames.skm": "สมุทรสงคราม",
        "provinceNames.pbi": "เพชรบุรี",
        "provinceNames.pkn": "ประจวบคีรีขันธ์",
        "provinceNames.nrt": "นครศรีธรรมราช",
        "provinceNames.kbi": "กระบี่",
        "provinceNames.pna": "พังงา",
        "provinceNames.pkt": "ภูเก็ต",
        "provinceNames.sni": "สุราษฎร์ธานี",
        "provinceNames.rng": "ระนอง",
        "provinceNames.cpn": "ชุมพร",
        "provinceNames.ska": "สงขลา",
        "provinceNames.stn": "สตูล",
        "provinceNames.trg": "ตรัง",
        "provinceNames.plg": "พัทลุง",
        "provinceNames.ptn": "ปัตตานี",
        "provinceNames.yla": "ยะลา",
        "provinceNames.nwt": "นราธิวาส",
        "provinceNames.lksg": "ทะเลสาบสงขลา",
