                ...
                return (
                    <section className="grid gap-4">
                        <div className="space-y-1">
                            <h2 className="text-sm font-semibold uppercase tracking-wide text-[var(--emerald-600)]">
                                {t("steps.bill.heading", { step: stepNumber })}
                            </h2>
                            <p className="text-sm text-[var(--emerald-700)]">
                                {t("steps.bill.description")}
                            </p>
                        </div>
                        <div className="grid gap-5 rounded-2xl border border-[var(--emerald-100)] bg-[var(--emerald-50)] p-5">
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                                <div>
                                    <p className="text-xs font-semibold uppercase tracking-wide text-[var(--emerald-600)]">
                                        {t("steps.bill.estimatedSpendLabel")}
                                    </p>
                                    <p className="text-3xl font-semibold text-[var(--emerald-900)]">
                            ...
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center justify-between text-xs font-medium uppercase tracking-wide text-[var(--emerald-700)]">
                                    <span>0฿</span>
                                ...
                                />
                                <div className="flex justify-between text-xs text-[var(--emerald-600)]">
            ...
            case 1:
                return (
                    <section className="flex flex-col gap-6 lg:grid-cols-[minmax(280px,1fr)_minmax(320px,1fr)]">
                        ...
                        <div className="grid gap-5 rounded-2xl border border-[var(--emerald-100)] bg-white p-4 lg:p-6">
                            <div className="grid gap-5 lg:grid-cols-[minmax(260px,1fr)_minmax(260px,1fr)] lg:items-start lg:gap-8">
                                <div className="grid gap-4">
                                    ...
                                    <div className="rounded-2xl border border-[var(--emerald-100)] bg-white p-3">
                                        <ThailandMap
                                            selectedProvinceId={
                                                selectedProvinceId
                                            }
                                ...
                                <div className="grid gap-5">
                                    <div className="grid gap-3 rounded-2xl border border-[var(--emerald-100)] bg-white p-4">
                                        <label
                                            htmlFor="province-select"
                                            className="text-xs font-semibold uppercase tracking-wide text-[var(--emerald-600)]"
                                        >
                                            {t(
                                    ...
                                    <div className="grid gap-4 rounded-2xl border border-[var(--emerald-100)] bg-white p-4">
                                        <p className="text-xs font-semibold uppercase tracking-wide text-[var(--emerald-600)]">
            ...
            case 2:
                return (
                    <section className="grid gap-4">
                        ...
                        <div className="grid gap-4 rounded-2xl border border-[var(--emerald-100)] bg-[var(--emerald-50)] p-5 sm:grid-cols-[1fr_auto] sm:items-center sm:gap-6">
                            <div className="space-y-1">
                                <p className="text-base font-medium text-[var(--emerald-900)]">
            ...
            case 3:
                return (
                    <div className="grid gap-6">
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`flex flex-col gap-3 rounded-2xl border bg-white p-4 transition sm:flex-row sm:items-center sm:justify-between ${
                                                isActive
                                                    ? "border-[var(--emerald-200)] bg-[var(--emerald-50)] shadow-sm"
                                                    : "border-[var(--emerald-100)]"
                                            }`}
                                        >
                                            <div className="flex w-full items-center justify-between gap-3 sm:w-auto">
                                                <span className="text-base font-medium text-[var(--emerald-900)]">
                                                    {appliance.label}
                                                </span>
                                                {isActive ? (
                                                    <span className="rounded-full bg-[var(--emerald-100)] px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-[var(--emerald-700)]">
                                                        {t(
                                            ...
                                            <div className="flex w-full flex-col gap-3 sm:w-72">
                                                <div className="flex items-center justify-between text-sm font-medium text-[var(--emerald-800)]">
                                                    <span>
                                                        {t(
                                                            "steps.appliances.quantityLabel"
                                                        )}
                                                    </span>
                                                    <span className="flex h-9 w-14 items-center justify-center rounded-full bg-[var(--emerald-100)] text-base font-semibold text-[var(--emerald-900)]">
                                                        {quantity}
                                                    </span>
                                                </div>
                                                <Slider
                                                ...
                                                />
                                                <div className="flex justify-between text-[11px] uppercase tracking-wide text-[var(--emerald-600)]">
                                                    <span>0</span>
                                                    <span>3</span>
                        ...
                        <section className="grid gap-3 rounded-2xl bg-[var(--emerald-600)] p-5">
                            <div className="flex items-baseline gap-2">
                                <span className="text-sm font-semibold uppercase tracking-wide text-[var(--emerald-700)]">
                            ...
                            <div className="grid gap-2 text-sm text-[var(--emerald-800)] sm:grid-cols-2">
                                <div>
                                    <p className="font-semibold text-[var(--emerald-900)]">
                                        {t("summary.monthlyBill")}
                                    </p>
                                    <p className="text-[var(--emerald-700)]">
                                        {formatBaht(monthlyBill)}
                                    </p>
                                </div>
                                <div>
                            ...
                            <p className="text-xs text-[var(--emerald-700)]">
                                {t("summary.cta")}
                            </p>
                        </section>
                    </div>
    ...
    return (
        <main className="mx-auto flex max-w-4xl flex-col items-center gap-10">
            <div className="text-center">
                <span className="rounded-full bg-[var(--emerald-200)] px-4 py-1 text-xs font-semibold uppercase tracking-wide text-[var(--emerald-800)]">
                    {t("hero.badge")}
                </span>
                <h1 className="mt-4 text-3xl font-semibold text-[var(--emerald-900)] sm:text-4xl">
                    {t("hero.title")}
                </h1>
                <p className="mt-2 max-w-2xl text-sm text-[var(--emerald-800)] sm:text-base">
                    {t("hero.subtitle")}
                </p>
            </div>
            ...
            <Card className="w-full">
                <CardHeader>
                    ...
                    <p className="mt-2 text-sm text-[var(--emerald-700)]">
                        {t("card.description")}
                    </p>
                </CardHeader>
                <CardContent className="grid gap-8">
                    <Stepper steps={steps} currentStep={currentStep} />
                    <div className="grid gap-6 rounded-3xl border border-[var(--emerald-100)] bg-white p-6">
                        {stepContent}
                    </div>
