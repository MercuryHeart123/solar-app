    ...
    return (
        <main className="py-6 space-y-6 2xl:px-72 ">
            <div className="text-center space-y-2">
                <h1 className="text-3xl font-semibold text-[var(--emerald-800)]">
                    {t("result.landing.title")}
                </h1>
                <h1 className="text-5xl font-semibold text-[var(--emerald-700)]">
                    3200 {"->"} 850
                </h1>

                <h2 className="text-lg text-[var(--emerald-600)]">
                ...
                <h2 className="text-sm text-[var(--emerald-600)]">
                    * ตัวเลขเป็นการประมาณการเบื้องต้นเท่านั้น
                </h2>
            </div>

            <section className="flex flex-col gap-2 rounded-2xl border border-[var(--emerald-100)] bg-white p-4">
                <Overall />
